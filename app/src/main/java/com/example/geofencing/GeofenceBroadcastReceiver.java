 ...
 //       Location location = geofencingEvent.getTriggeringLocation();
        ...
        switch (trasitiontype){
            ...
            case Geofence.GEOFENCE_TRANSITION_ENTER:
                ...
                notificationHelper.sendHighPriorityNotification("GEOFENCE TRANSITION ENTER","You Entered in Geofence",MapsActivity.class);
                break;
            case Geofence.GEOFENCE_TRANSITION_DWELL:
                Toast.makeText(context, "You are in the Geofence", Toast.LENGTH_SHORT).show();
                notificationHelper.sendHighPriorityNotification("GEOFENCE TRANSITION DWELL","You are in the Geofence",MapsActivity.class);
                break;
            case Geofence.GEOFENCE_TRANSITION_EXIT:
                Toast.makeText(context, "You Exit from Geofence", Toast.LENGTH_SHORT).show();
                notificationHelper.sendHighPriorityNotification("GEOFENCE_TRANSITION_EXIT","You Exit from Geofence",MapsActivity.class);
                break;
        }
